...
public class Schema implements Serializable {
    ...
    public List<String> getSpannerColumnNames(String spannerTableName) {
    ...
    public Set<String> getPrimaryKeySet(String spannerTableName) {
        String tableId = this.spannerToID.get(spannerTableName).getName();
        return this.spSchema.get(tableId).getPrimaryKeySet();
    }
