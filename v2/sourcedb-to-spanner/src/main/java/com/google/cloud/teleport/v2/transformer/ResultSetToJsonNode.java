...
public class ResultSetToJsonNode implements JdbcIO.RowMapper<JsonNode> {
    ...
    public JsonNode convertToChangeEventJson(ResultSet rs, String tableName) throws SQLException {
        ...
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            // Add handling for standardisation for each type.
            LOG.info("Column name: {}, Column Type: {}, Column Value: {}", metaData.getColumnName(i), metaData.getColumnType(i), rs.getObject(i));
            JsonNode valueNode;
