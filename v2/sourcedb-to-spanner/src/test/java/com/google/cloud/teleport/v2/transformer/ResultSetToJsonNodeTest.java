...
public class ResultSetToJsonNodeTest {
    ...
    public void convertToChangeEventJsonBasic() throws Exception {
        ...
        when(rsMetaMock.getColumnCount()).thenReturn(5);
        ...
        JsonNode expected =
                mapper.readTree(
                        String.format("{\"%s\":\"test_table\", \"col1\":1, \"col2\": \"value\", \"bytes_column\": \"7835383030\", \"timestamp_column\": \"2022-08-05T08:23:11.0\", \"bool_column\": true}", Constants.EVENT_TABLE_NAME_KEY));
